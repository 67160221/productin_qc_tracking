...
| **Edge Case Simulator** | จำลองสถานการณ์ผิดปกติ (เน็ตหลุด, เครื่องพัง, ของเสียวิกฤต) |
...
>  สำหรับการใช้งานจริง (Production) ควรเปลี่ยนรหัสผ่านฐานข้อมูลและบัญชีทดสอบทั้งหมด
